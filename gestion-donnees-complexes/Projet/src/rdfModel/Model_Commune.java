...
import hbase.database.Commune;
import hbase.database.CreateTable;
...
public class Model_Commune {
	...
	public static Model Commune_Model() throws IOException{
		...
		for(Commune comms:listeCommune){
			...
			Resource com = communeModel.createResource(commune.getURI()+"/"+comms.departement+comms.COM);
