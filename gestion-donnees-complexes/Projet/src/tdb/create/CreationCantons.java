...
public class CreationCantons
{
    ...
    public void createcantons()
    {
        ...
        String directory = "/home/gentringer/universite/Master2-Aigle/gestion-donnees-complexes/Projet/tdb/cantons-database" ;
        Dataset ds = TDBFactory.createDataset(directory) ;
        Model reg = ds.getNamedModel( "cantons" ); 
        File folder = new File("./Insee-Cantons"); 
        ArrayList<String> arronds = listFiles(folder);
        for(String arron : arronds){
        	System.out.println(arron);
            FileManager.get().readModel( reg, "./Insee-Cantons/"+arron );        
