...
public class CreationArrondissement
{
    ...
    public void createarrondissement()
    {
        ...
        String directory = "/home/gentringer/universite/Master2-Aigle/gestion-donnees-complexes/Projet/tdb/arrondissement-database" ;
        Dataset ds = TDBFactory.createDataset(directory) ;
        Model reg = ds.getNamedModel( "arrondissements" ); 
        File folder = new File("./Insee-Arrondissements"); 
        ArrayList<String> arronds = listFiles(folder);
        for(String arron : arronds){
        	System.out.println(arron);
            FileManager.get().readModel( reg, "./Insee-Arrondissements/"+arron );        
