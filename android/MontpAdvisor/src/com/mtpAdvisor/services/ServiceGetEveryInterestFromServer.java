...
public class ServiceGetEveryInterestFromServer extends IntentService{
	...
	public ServiceGetEveryInterestFromServer() {
	...
	protected void onHandleIntent(Intent intent) {
		...
		ArrayList<Interest> interestList = new ArrayList<Interest>();
			...
			String url_all_products = "http://gillesentringer.com/php/get_all_interests.php";
	...
	private void publishResults(ArrayList<Interest> al2) {
		Intent intent = new Intent("ALLINTERESTS");
		//		for(Interest b: al2){
		//	System.out.println("bar: "+b.name);
		//		}
		intent.putParcelableArrayListExtra("everyInterest", al2);
